...
import org.apache.spark.shuffle.dfs.DistributedFSSplashOpts;
...
class FileContextManager {
  ...
  static {
    ...
    val shuffleFileSystem = sparkConf
      .get(DistributedFSSplashOpts.dfsFileSystem().key(), hadoopConf.get(FS_DEFAULT_NAME_KEY, FS_DEFAULT_NAME_DEFAULT));
    hadoopConf.set(FS_DEFAULT_NAME_KEY, shuffleFileSystem);
  }
